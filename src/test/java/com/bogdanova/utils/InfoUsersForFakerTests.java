...
import com.bogdanova.utils.MonthForDate;
import com.github.javafaker.Faker;

import java.util.Locale;

    public class InfoUsersForFakerTests {
        ...
        public static String pic = "3.png";
        public static String hobby = "Sports";
        public static String subject = "English";
        public static String path = "src/test/resources/3.png";
        ...
        public static String month = String.valueOf(MonthForDate.getRandomMonth());
